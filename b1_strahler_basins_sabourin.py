# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#   watershed-workflows: Strahler Basins (Sabourin)
#
#   name: b1_strahler_basins_sabourin.py
...
out = work + r"\strahler_method\out_sabourin"

# Declare a name for our test data.

dem_sab = input + r"\in\DEM_level12_sabourin.tif"   
parcels = input + r"\in\parcel_study_region_sabourin.shp"  
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
#   CLIP BASINS AND STREAMS TO PARCEL.
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
wbt.clip_raster_to_polygon(
    ...
    polygons = parcels, 
    output = out + r"\_10_strahler_basins_sabourin.tif", 
...
wbt.clip_raster_to_polygon(
    ...
    polygons = parcels, 
    output = out + r"\_05_strahler_streams_sabourin.tif", 
    maintain_dimensions=False, 
    #callback=default_callback
)
...
wbt.clip_raster_to_polygon(
    ...
    polygons = parcels, 
    output = out + r"\_02_flow_direction_sabourin.tif", 
    maintain_dimensions=False, 
    #callback=default_callback
)
...
wbt.raster_streams_to_vector(
    ...
    output = out + r"\_12_VECTOR_streams_sabourin.shp", 
    esri_pntr=False, 
    #all_vertices=False, 
    #callback=default_callback
)
...
'''
    ...
    ** THIS STEP SHOULD BE PERFORMED IN QGIS UNTIL 
    wbt.extract_by_attribute() bug is resolved **
