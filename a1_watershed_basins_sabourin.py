# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#   watershed-workflows: Watershed Basins (Sabourin)
#
#   name: a1_strahler_basins_harris.py
#   authors: Lake Willet
...
wbt.raster_streams_to_vector(
    ...
    output = out + r"\_12_VECTOR_streams.shp", 
    esri_pntr = False, 
    #all_vertices=False, 
    #callback=default_callback
)
...
# wbt.extract_by_attribute(
#     i = out + r"\_12_VECTOR_strahler_basins_sabourin.shp",
#     output = out + r"\_14_Q_OrderY.shp",
#     statement = "VALUE==3.0000"
# )
